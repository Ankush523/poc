    ...
    <div className='flex flex-col'>
        ...
        <div className='flex flex-row mx-[15%] justify-between mt-[3%]'>
            <div className='flex flex-col border border-grey1 w-[40%] rounded-2xl'>
                <div className='flex flex-col border border-grey2 m-[3%] bg-grey3 rounded-lg p-[3%]'>
                ...
                <div className='flex flex-col border border-grey2 mx-[3%] mb-[3%] bg-grey3 rounded-lg py-[3%] px-[1%]'>
            ...
            <div className='flex flex-col w-[58%] border border-grey1 backdrop-blur-sm bg-white/30 rounded-2xl'>
                <div className='flex flex-col r border border-grey1 m-[2%] h-[80%] bg-grey3 rounded-lg'>
                ...
                <div className='flex flex-row border border-grey1 mx-[2%] mb-[2%] py-[3%] bg-grey3 rounded-lg'>
                    <img src={bulb} alt="bulb" className='w-[10%] my-[5%] mx-[2%]'/>
                    <div className='flex flex-col text-left'>
                        <label className='text-xl text-white1 mb-[3%]'>What is DCA?</label>
