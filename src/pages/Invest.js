    ...
    <div className='flex flex-col'>
        ...
        <div className='flex flex-row mx-[15%] justify-between mt-[3%]'>
            <div className='flex flex-col border border-grey1 w-[40%] rounded-2xl'>
                <div className='flex flex-col border border-grey2 m-[3%] bg-grey3 rounded-xl p-[3%]'>
                ...
                <div className='flex flex-col border border-grey2 mx-[3%] mb-[3%]'>
                    <label className='text-white1'>Sell/Receive</label>
                </div>

                <div className='flex flex-col border border-grey2 mx-[3%] mb-[3%]'>
                    <button className='text-white1 border border-grey2 m-[2%]'>Continue</button>
                </div>
            </div>


            <div className='flex flex-col w-[55%] border border-grey1 backdrop-blur-sm bg-white/30'>
                <div className='border border-grey1 mx-[3%] my-[3%] h-[50%]'>
                    <label className='text-white1'> Select a pair to view its price history</label>
                </div>
                <div className='flex flex-row border border-grey1 mx-[3%] mb-[3%]'>
                    <img/>
                    <div className='flex flex-col'>
                        <label className='text-xl text-white1'>What is DCA?</label>
